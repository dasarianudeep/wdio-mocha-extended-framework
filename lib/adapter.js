...
import Mocha from 'mocha-extended'

import { runInFiberContext, wrapCommands, executeHooksWithArgs } from 'wdio-extended-sync'
    ...
    async run () {
        ...
        mocha.suite.on('pre-require', (context, file, mocha) => {
            ...
            INTERFACES[mochaOpts.ui].forEach((fnName) => {
                ...
                runInFiberContext(
                    [testCommand, testCommand + '.only', testCommand + '.P1', testCommand + '.P2'],
